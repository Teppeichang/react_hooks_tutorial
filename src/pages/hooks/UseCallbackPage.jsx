      ...
      <Box sx={{ width: 800, mb: 10 }}>
        <Accordion>
          ...
          <AccordionDetails>
            ...
            ></iframe>
            <p>上記ソースコードのコンソール出力結果は true であるが、厳密に言えば false である。</p>
            <p>
        ...
        <Accordion>
          ...
          <AccordionDetails>
            ...
            <p className="mt-5">前提として、子コンポーネントはmemoでメモ化する必要がある。</p>
            <p>
              (useCallbackはあくまで「関数」をメモ化するもので、コンポーネント自体はメモ化の対象外。)
            </p>
            <p className="mt-5">
              useCallbackを使用することで関数自体がキャッシュされ、さらに関数の参照が保持される。
            </p>
            <iframe
            ...
            <p className="mt-5">
              本ページのサンプルは、第二引数の依存配列に空配列を指定したパターンで実装している。
            </p>
            <iframe
